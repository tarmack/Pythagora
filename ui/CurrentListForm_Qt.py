...
class Ui_CurrentListForm(object):
    def setupUi(self, CurrentListForm):
        ...
        CurrentListForm.resize(378, 304)
        ...
        self.currentFilter = QtGui.QLineEdit(self.playlistTools)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("../icons/edit-clear-list.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("../icons/document-save-as.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("../icons/task-recurring.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("../icons/media-playlist-shuffle.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
